...
(function (global, factory) {
  ...
  var CardWidget = /*#__PURE__*/function () {
    ...
    _proto.collapse = function collapse() {
      ...
      this._parent.addClass(CLASS_NAME_COLLAPSING).children(SELECTOR_CARD_BODY ).slideUp(this._settings.animationSpeed, function () {
    ...
    _proto.expand = function expand() {
      ...
      this._parent.addClass(CLASS_NAME_EXPANDING).children(SELECTOR_CARD_BODY ).slideDown(this._settings.animationSpeed, function () {
